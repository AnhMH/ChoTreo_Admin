        ...
        <div class="orders-act">
            <div class="col-md-4 col-md-offset-2">
                <div class="left-action text-left clearfix">
                    <h2>Đơn hàng &raquo; <?php echo !empty($order['code']) ? $order['code'] : ''; ?></h2>
                </div>
            </div>
            <div class="col-md-6">
                <div class="right-action text-right">
                    <div class="btn-groups">
                        <?php if (empty($id)): ?>
                        <button type="button" class="btn btn-primary"  onclick="cms_save_orders(0, <?php echo $id; ?>)">
                            <i class="fa fa-floppy-o"></i> Khởi tạo
                        </button>
                        <?php endif; ?>
                        <button type="button" class="btn btn-primary"  onclick="cms_save_orders(<?php echo isset($order['status']) ? $order['status'] : '1'; ?>, <?php echo $id; ?>)"><i
                            ...
                            <div class="form-group marg-bot-10 clearfix">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="radio" class="payment-method" name="method-pay" value="1" <?php echo (!empty($order['payment_method']) && $order['payment_method'] == 1) ? 'checked' : ''; ?>>
                                        Tiền mặt &nbsp;
